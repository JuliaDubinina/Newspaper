...
SECRET_KEY = 'django-insecure-c2120r5s1-j1mdzf*qrlathttg^d0v!ep%hgk%t=d2cwv!bl%o'
...
EMAIL_USE_TLS = True
EMAIL_PORT = 587
EMAIL_HOST_USER = "django.pytest@gmail.com"
EMAIL_HOST_PASSWORD = "wvhujsyhpkkxpkaa"
